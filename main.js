...
function Model(name) {
    ...
    this.BufferData = function(vertices, normal, textures) {
...
function initGL() {
    ...
    shProgram.iTranslateTo = gl.getUniformLocation(prog, "transl");

    surface = new Model('Surface');
    let data = CreateSurfaceData();
    surface.BufferData(data.vertices, data.normal, data.textures);
